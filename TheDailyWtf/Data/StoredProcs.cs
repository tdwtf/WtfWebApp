...
namespace TheDailyWtf.Data.StoredProcedures
{
	...
	/// 
	/// </summary>
	public class Articles_FixMissingAds : WrappedStoredProcedure<SqlServerDataFactory>
	{
	...
	/// 
	/// </summary>
	public class Comments_GetCommentById : WrappedStoredProcedure<SqlServerDataFactory>
	{
	...
	/// 
	/// </summary>
	public class Comments_GetCommentIndex : WrappedStoredProcedure<SqlServerDataFactory>
	{
		public Comments_GetCommentIndex(int? Comment_Id, int? Comment_Index)
		{
			AddParam("@Comment_Id", DbType.Int32, 0, ParameterDirection.Input, Comment_Id);
			AddParam("@Comment_Index", DbType.Int32, 0, ParameterDirection.InputOutput, Comment_Index);
		}

		public int? Comment_Index { get { return GetParamVal<int?>("@Comment_Index"); } }
		public int? Execute()
		{
			this.ExecuteNonQuery();
...
namespace TheDailyWtf.Data
{
	public static class StoredProcs
	{
		...
		public static StoredProcedures.Articles_FixMissingAds Articles_FixMissingAds()
		{
			return new StoredProcedures.Articles_FixMissingAds();
		}
		...
		public static StoredProcedures.Comments_GetCommentById Comments_GetCommentById(int? Comment_Id)
		{
			return new StoredProcedures.Comments_GetCommentById(Comment_Id);
		}

		public static StoredProcedures.Comments_GetCommentIndex Comments_GetCommentIndex(int? Comment_Id, int? Comment_Index = null)
		{
			return new StoredProcedures.Comments_GetCommentIndex(Comment_Id, Comment_Index);
		}
